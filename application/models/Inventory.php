...
class Application_Model_Inventory {
    ...
    public function get_qoh_orders_by_item($itemNumber) {
        return $this->_db->fetchAll("SELECT id as value, quantity_oh_china as quantity from inventory_order WHERE itemNumber = '$itemNumber' and quantity_oh_china > 0 order by created_time");        
    }

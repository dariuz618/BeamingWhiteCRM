...
$tokenUrl = $credentials['server'] . '/restapi/v1.0/account/'.$credentials['accountId'].'/extension/'.$credentials['extensionId'].'/ringout';
    
$values = array(
    'from' => array("phoneNumber" => $credentials['from']),
    'to' => array("phoneNumber" => $credentials['to'])
...
<html>
    ...
    <body>
        <h1>RingCentral - Ringout Call </h1>
		<p>Ringout Call</p>

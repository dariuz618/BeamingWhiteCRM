    ...
    public function formSource($name, $value = null, $attribs = null)
    {
     ...
     return '
        ...
        <input type="radio" name='. $name.' value="Referred" '.$referred.'>Referred 
            <input type="text" name='. $name.'_refer value="'.$source_refer.'" placeholder="Who Referred you?" style="margin-left:88px;margin-bottom:10px;"><br>
        ...
        <input type="radio" name='. $name.' value="Tradeshow" '.$tradeshow.' >Trade Show
            <input type="text" name='. $name.'_tradeshow value="'. $source_tradeshow.'" placeholder="Which Trade Show?" style="margin-left:70px;margin-bottom:10px;" ><br> 
        <input type="radio" name='. $name.' value="Other" '.$other.'>Other
            <input type="text" name='. $name.'_other value="'. $source_other.'" placeholder="Other" style="margin-left:105px;"><br> 
        </div>
        ';

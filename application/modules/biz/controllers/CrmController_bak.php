...
class CrmController extends Zend_Controller_Action {
               ...
               // var_dump($_POST);
                ...
                //  $data['imported'] = 'Web Form';
                 ...
                 // unset($data['parentAccountID']);
                  //var_dump($data);                
                  $insert = $this->_crms->saveContact($data);
    ...
    public function getLeadsAction() {               
       ...
       //echo $start; echo $end;        
        $result['rows'] = $this->_crms->getUsersPage ('Lead', $sort, $order, $offset, $rows, $rep, $potential, $source, $soldBy, $lastAttempt);
        
        $total = $this->_crms->getUsersTotal('Lead', $rep, $potential,$source, $soldBy, $lastAttempt);
    ...
    public function prospectAction() {        
     ...
     public function getProspectAction() {     
       ...
       //echo $start; echo $end;        
        $result['rows'] = $this->_crms->getUsersPage ('Prospect', $sort, $order, $offset, $rows, $rep, $potential, $source, $soldBy, $lastAttempt);
        
        $total = $this->_crms->getUsersTotal('Prospect', $rep, $potential,$source, $soldBy, $lastAttempt);
        $result['total'] = $total['total'];
    ...
    public function getAccountsAction() {
       ...
       //echo $start; echo $end;        
        $result['rows'] = $this->_crms->getUsersPage ('Account', $sort, $order, $offset, $rows, $rep, $potential, $source, $soldBy, $lastAttempt);
        
        $total = $this->_crms->getUsersTotal('Account', $rep, $potential,$source, $soldBy, $lastAttempt);
        $result['total'] = $total['total'];
